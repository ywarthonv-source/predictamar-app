...
# ================================================================
# BLOQUE 2 -- SENTINEL-2 OPTICO
# ================================================================
print("\n[2/5] Descargando Sentinel-2 optico...")
sys.stdout.flush()
...
try:
    ...
    if s2_count > 0:
        ...
        print(f"  S2 OK -- antiguedad: {s2_antiguedad_dias}d | Fc: {Fc_s2:.2f}")
    else:
        print(f"  S2 sin dato limpio -- nubosidad")
except Exception as e:
    print(f"  S2 error: {e}")
sys.stdout.flush()

# ================================================================
# BLOQUE 3 -- ALOS-2 PALSAR-2
# ================================================================
...
try:
    ...
    if alos2_count > 0:
        ...
        print(f"  ALOS-2 OK -- antiguedad: {alos2_antiguedad_dias}d | Fc: {Fc_alos2:.2f}")
    else:
...
try:
    ...
    sst_data = ds_sst['analysed_sst'].values - 273.15
...
# ================================================================
# BLOQUE 5 -- BATIMETRIA ETOPO1
# ================================================================
print("\n[5/5] Cargando batimetria ETOPO1...")
sys.stdout.flush()
...
if S2_DISPONIBLE and s2_antiguedad_dias <= FC_S2_MAX_DIAS:
    ...
    print(f"  Modo degradado -- S2 con {s2_antiguedad_dias}d de antiguedad")
...
# HISTORIAL 90 DIAS
# ================================================================
print("\nActualizando historial 90 dias...")
sys.stdout.flush()
