...
try:
    ...
    if s1_count > 0:
        ...
        print(f"  S1 OK -- antig?edad: {s1_antiguedad_dias}d | Fc: {Fc_s1:.2f}")
    else:
        print("  S1 sin dato reciente -- usando climatol?gico")
...
# ================================================================
# BLOQUE 2 -- SENTINEL-2 OPTICO (10m - solo cielo despejado)
# ================================================================
print("\n[2/5] Descargando Sentinel-2 ?ptico...")
sys.stdout.flush()
...
try:
    ...
    if s2_count > 0:
        ...
        # Indice de turbidez costera (ratio B4/B3)
        ...
        # Clorofila proxy lag: buscamos dato de hace LAG_CHL_DIAS dias
        ...
        print(f"  S2 OK -- antig?edad: {s2_antiguedad_dias}d | Fc: {Fc_s2:.2f} | lag CHL {LAG_CHL_DIAS}d OK")
    else:
        print(f"  S2 sin dato limpio en ?ltimos {FC_S2_MAX_DIAS + 3} d?as -- nubosidad")
...
try:
    ...
    if alos2_count > 0:
        ...
        # Gradiente estructural banda L (corrientes y batimetria)
        ...
        print(f"  ALOS-2 OK -- antig?edad: {alos2_antiguedad_dias}d | Fc: {Fc_alos2:.2f}")
    else:
...
# ================================================================
# BLOQUE 5 -- BATIMETRIA GEBCO (estatica)
# ================================================================
print("\n[5/5] Cargando batimetr?a GEBCO...")
sys.stdout.flush()

try:
    gebco = ee.Image(GEE_GEBCO).select('elevation').clip(AOI)
    # Pendiente del fondo (slope) -- proxy de micro-surgencia topografica
...
if S2_DISPONIBLE and s2_antiguedad_dias <= FC_S2_MAX_DIAS:
    ...
    print(f"  Modo degradado -- S2 con {s2_antiguedad_dias}d de antig?edad")

if not S1_DISPONIBLE:
    CONFIANZA_BASE = CONFIANZA_BAJA
    print("  Confianza baja -- S1 no disponible, usando climatol?gico")
...
# HISTORIAL 90 DIAS
# ================================================================
print("\nActualizando historial 90 d?as...")
sys.stdout.flush()
